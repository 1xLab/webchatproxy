...
This browser extension connects to the separate server in `../server`, which exposes your **logged-in ChatGPT session** as a standard OpenAI-compatible API at `localhost:3000`.
...
└── package.json            # Extension build scripts
```
